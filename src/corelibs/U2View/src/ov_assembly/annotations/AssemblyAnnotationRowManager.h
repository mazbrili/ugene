...
#ifndef _ASSEMBLY_ANNOTATION_ROW_MANAGER_
#define _ASSEMBLY_ANNOTATION_ROW_MANAGER_
...
class AssemblyAnnotationRowManager : public QObject {
    Q_OBJECT
public:
    AssemblyAnnotationRowManager(AssemblyBrowserUi *ui);
...
#endif // _ASSEMBLY_ANNOTATION_ROW_MANAGER_
